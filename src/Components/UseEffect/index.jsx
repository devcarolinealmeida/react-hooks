  ...
  return (
    <section className="border border-slate-500 rounded p-2 mt-2">
      ...
      <div className="mt-10 w-96">
        <h1 className="font-bold text-center border-slate-500 border-2 rounded mb-2">
          {resourceType}
        </h1>
        <div className="flex justify-between">
          <button
            onClick={() => changeResourseType("Posts")}
            className="my-1 p-2 bg-slate-500 text-white rounded hover:bg-slate-800"
          >
            Posts
          </button>
          <button
            onClick={() => changeResourseType("Comments")}
            className="my-1 p-2 bg-slate-500 text-white rounded hover:bg-slate-800"
          >
            Comments
          </button>
          <button
            onClick={() => changeResourseType("Todos")}
            className="my-1 p-2 bg-slate-500 text-white rounded hover:bg-slate-800"
          >
            To-dos
          </button>
